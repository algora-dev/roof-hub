...
export default function AboutPage() {
  return <>
    <section className="page-hero page-hero--sage"><div className="container narrow"><p className="eyebrow">About RoofHub</p><h1>A roofing research and planning layer — not another roofing contractor website.</h1><p>The aim is to help New Zealand homeowners, property people and industry users understand a roofing project before they decide who to contact.</p></div></section>
