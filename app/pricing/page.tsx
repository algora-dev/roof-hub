...
export default function PricingPage() {
  return <>
    <section className="page-hero page-hero--sage"><div className="container page-hero-grid"><div><p className="eyebrow">Roofing pricing · prototype page</p><h1>Understand the project before chasing a quote.</h1><p>This page tests how RoofHub can present indicative NZ roofing pricing: range first, assumptions visible, uncertainty preserved, and a clear boundary between an estimate and a formal quote.</p><div className="draft-notice"><strong>Development content:</strong> the numbers in the calculator below are illustrative only. They are not verified NZ market pricing and GST treatment is not yet configured.</div></div><div className="page-hero-media"><Image src="/media/pricing-roof.webp" alt="Aerial view of a dark residential roof" fill priority sizes="(max-width: 980px) 100vw, 34vw"/><span>NZD · preliminary planning only</span></div></div></section>
