    ...
    <>
      <section className="hero hero--home">
        <div className="container hero-grid">
          <div className="hero-copy">
            ...
            <p className="hero-lede">RoofHub is being built as a practical roofing research, pricing, measurement and project-planning platform — useful before you ever contact a roofer.</p>
            ...
            <div className="hero-proof"><span><Check /> Useful answers first</span><span><Check /> Transparent assumptions</span><span><Check /> NZ focused</span></div>
          </div>
          <div className="hero-visual" aria-label="Example RoofHub project summary">
            <div className="roof-geometry" aria-hidden="true"><span className="roof-geometry__left"/><span className="roof-geometry__right"/></div>
            <div className="project-panel">
              ...
              <p>One clear place for measurements, pricing context, assumptions and next steps.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="section section--sage-soft">
        <div className="container feature-split">
          <div><p className="eyebrow">A platform, not a contractor brochure</p><h2>One roofing decision layer.<br/>Several ways to use it.</h2><p>RoofHub can bring together pricing, measurements, technical explanations, photo or plan analysis, comparisons and enquiry context without pretending to be the company doing the roofing work.</p><Link className="text-link" href="/about">How RoofHub works <ArrowRight /></Link></div>
      ...
      <section className="section section--dark"><div className="container dark-cta"><div><p className="eyebrow">Design-system proof point</p><h2>See how a real RoofHub tool result could feel.</h2><p>The pricing page contains a working prototype interaction so we can test the visual hierarchy before integrating the actual pricing engine.</p></div><Link className="button button--primary button--large" href="/pricing">Try the pricing prototype <ArrowRight /></Link></div></section>

      <section className="section"><div className="container"><SectionHeading eyebrow="Guides & research" title="Build confidence before the quote" /><div className="resource-grid"><Link className="resource-card resource-card--feature" href="/guides/how-to-prepare-for-a-roofing-quote"><div className="resource-art resource-art--sage"><span className="roof-line"/></div><p className="eyebrow">5 min guide</p><h3>How to prepare for a roofing quote</h3><p>A practical checklist for getting comparable, useful roofing quotes.</p><span className="card-link">Read guide <ArrowRight /></span></Link><div className="resource-card resource-card--muted"><div className="resource-art resource-art--terracotta"><Calculator /></div><p className="eyebrow">Coming next</p><h3>What does a reroof price actually include?</h3><p>Scope, removal, access, flashings, underlay, disposal and other project variables.</p></div><div className="resource-card resource-card--muted"><div className="resource-art resource-art--neutral"><Measure /></div><p className="eyebrow">Coming next</p><h3>How roof area and pitch affect the project</h3><p>A plain-English explanation of measured area, plan area, pitch and waste.</p></div></div></div></section>
    </>
  );
}
